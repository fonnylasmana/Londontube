...
Insert into dbo.TubeLine 
(TubeLineName,FromStation,ToStation) 
values 
...
('Circle','Edgware Road (Circle/District/Hammersmith and City)','Baker Street'),
...
('Circle','Hammersmith (Met.)','Goldhawk Road'),
('Circle','Paddington','Edgware Road (Circle/District/Hammersmith and City)'),
...
('District','Earls Court','Kensington (Olympia)'),
('District','Paddington','Edgware Road (Circle/District/Hammersmith and City)'),
...
('District','Hammersmith (District)','Ravenscourt Park'),
('District','Barons Court','Hammersmith (District)'),
...
('Hammersmith and City','Hammersmith (Met.)','Goldhawk Road'),
...
('Hammersmith and City','Edgware Road (Circle/District/Hammersmith and City)','Baker Street'),
('Hammersmith and City','Paddington','Edgware Road (Circle/District/Hammersmith and City)'),
...
('Overground','Shepherds Bush','Kensington (Olympia)'),
...
('Overground','Kensington (Olympia)','West Brompton'),
...
('Piccadilly','Barons Court','Hammersmith (District)'),
('Piccadilly','Hammersmith (District)','Turnham Green'),
...
('Victoria','Kings Cross St. Pancras','Warren Street'),
